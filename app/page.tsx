  ...
  return (
    <footer style={{ backgroundColor: C.dark, borderTop: `1px solid ${C.border}`, padding: "60px 40px 32px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div className="footer-btm-row" style={{ borderTop: `1px solid ${C.border}`, paddingTop: "24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "8px" }}>
